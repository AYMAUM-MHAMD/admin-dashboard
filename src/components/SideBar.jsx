...
const SideBar = ({ open, handleDrawerClose }) => {
  ...
  return (
    <Drawer variant="permanent" open={open}>
      ...
      <Avatar sx={{ mx: "auto", width: open ? 88 : 44, height: open ? 88 : 44, my: 1, border: "2px solid grey", transition: "0.25s" }} alt="Remy Sharp" src="https://i.pinimg.com/originals/d8/1f/6f/d81f6fa8fb399c711358be3d2037250a.png" />
      <Typography align='center' sx={{ fontSize: open ? 17 : 0, transition: "0.25s" }}>Layla Ali</Typography>
